"""Regression checks for the drift-data-ingest-gate casebook."""
...
from casebook.harness import assert_expected, drift_data_ingest_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(drift_data_ingest_gate_summary(), assert_expected())
